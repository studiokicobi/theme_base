	...
	<section>
		...
		<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
				...
				<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					<?php the_tags(__('Tags: ', 'theme_base'), ', ', '<br>'); // Separated by commas with a line break at the end 
					?>

					<p><?php _e('Categorised in: ', 'theme_base');
						the_category(', '); // Separated by commas 
						?></p>

					<p><?php _e('This post was written by ', 'theme_base');
						the_author(); ?></p>
		...
		<?php else : ?>
			...
			<article>
				...
				<h1><?php _e('Sorry, nothing to display.', 'theme_base'); ?></h1>
